...
region              = "North Europe"
resource_group_name = "transit-vnet-dedicated-vwan"
name_prefix         = "example-"
tags = {
    ...
    virtual_machine = {
      ...
      */
      ...
      bootstrap_package = {
        bootstrap_storage_key  = "bootstrap"
        static_files           = { "files/init-cfg.txt" = "config/init-cfg.txt" } # TODO: Modify the map key to reflect a path to init-cfg file
        bootstrap_xml_template = "templates/bootstrap_obew.tmpl"                  # TODO: Insert a path to bootstrap template file
        private_snet_key       = "private"
        public_snet_key        = "public"
        intranet_cidr          = "10.0.0.0/8"
      }
...
test_infrastructure = {
  ...
  "app3_testenv" = {
    vnets = {
      "app3" = {
        name          = "app3-vnet"
        address_space = ["10.100.2.0/25"]
        network_security_groups = {
          "app3" = {
            name = "app3-nsg"
            rules = {
              from_bastion = {
                name                       = "app3-mgmt-allow-bastion"
                priority                   = 100
                direction                  = "Inbound"
                access                     = "Allow"
                protocol                   = "Tcp"
                source_address_prefix      = "10.100.2.64/26"
                source_port_range          = "*"
                destination_address_prefix = "*"
                destination_port_range     = "*"
              }
              web_inbound = {
                name                       = "app3-web-allow-inbound"
                priority                   = 110
                direction                  = "Inbound"
                access                     = "Allow"
                protocol                   = "Tcp"
                source_address_prefixes    = ["1.1.1.1/32"] # TODO: Whitelist public IP addresses that will be used to access test infrastructure
                source_port_range          = "*"
                destination_address_prefix = "10.100.2.0/25"
                destination_port_ranges    = ["80", "443"]
              }
            }
          }
        ...
        subnets = {
          "vms" = {
            ...
            network_security_group_key = "app3"
          }
          "bastion" = {
            name             = "AzureBastionSubnet"
